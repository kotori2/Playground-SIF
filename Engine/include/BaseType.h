...
#define CLS_KLBUISHADER			(51| CLS_KLBUSERTASK)
#define CLS_KLBUITEXTINPUT		(52| CLS_KLBUSERTASK)

// export objects
#define CLS_KLBBINARRAY     (53| CLS_KLBENGINECLASS)
#define CLS_KLBLUADB        (54| CLS_KLBENGINECLASS)
#define CLS_KLBDATASET      (55| CLS_KLBENGINECLASS)
#define CLS_KLBNODEVIRTUALDOC	(56 | CLS_KLBENGINECLASS | CLS_KLBUICORECLASS)
#define CLS_KLBFONTOBJ		(57| CLS_KLBENGINECLASS)
#define CLS_KLBSOUNDOBJ		(58| CLS_KLBENGINECLASS)
#define CLS_KLBMATRIXOBJ	(59| CLS_KLBENGINECLASS)
#define CLS_KLBVECTOROBJ	(60| CLS_KLBENGINECLASS)

#define CLS_KLBUNITTASK		(61| CLS_KLBUSERTASK)
#define CLS_KLBMAPGROUP		(62| CLS_KLBUSERTASK)

#define CLS_KLBSTORESERVICE	(63| CLS_KLBUSERTASK | CLS_NONVISUALTASK)
#define CLS_KLBNETAPI		(64| CLS_KLBUSERTASK | CLS_NONVISUALTASK)
#define CLS_KLBPAUSECTRL	(65| CLS_KLBUSERTASK | CLS_NONVISUALTASK)
#define CLS_KLBLIFECTRL		(66| CLS_KLBUSERTASK | CLS_NONVISUALTASK)
