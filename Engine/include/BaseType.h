...
#define CLS_KLBUICOVER			(38| CLS_KLBUSERTASK)
#define CLS_KLBUIDBGLABEL		(39| CLS_KLBUSERTASK)
#define CLS_KLBUIDRAGICON		(40| CLS_KLBUSERTASK)
#define CLS_KLBUIFREEVERTITEM	(41| CLS_KLBUSERTASK)
#define CLS_KLBUIGROUP			(42| CLS_KLBUSERTASK)
#define CLS_KLBUILABEL			(43| CLS_KLBUSERTASK)
#define CLS_KLBUILIST			(44| CLS_KLBUSERTASK)
#define CLS_KLBUIMOVIEPLAYER	(45| CLS_KLBUSERTASK)
#define CLS_KLBUIMULTIIMGITEM	(46| CLS_KLBUSERTASK)
#define CLS_KLBUIPIECHART		(47| CLS_KLBUSERTASK)
#define CLS_KLBUIPOLYGON		(48| CLS_KLBUSERTASK)
#define CLS_KLBUIPOLYLINE		(49| CLS_KLBUSERTASK)
#define CLS_KLBUIPOLYLINE2		(50| CLS_KLBUSERTASK)
#define CLS_KLBUIRUBBERBAND		(51| CLS_KLBUSERTASK)
#define CLS_KLBUISCALE9			(52| CLS_KLBUSERTASK)
#define CLS_KLBUISIMPLEITEM		(53| CLS_KLBUSERTASK)
#define CLS_KLBUISHADER			(54| CLS_KLBUSERTASK)
#define CLS_KLBUITEXTINPUT		(55| CLS_KLBUSERTASK)

// export objects
#define CLS_KLBBINARRAY         (56| CLS_KLBENGINECLASS)
#define CLS_KLBLUADB            (57| CLS_KLBENGINECLASS)
#define CLS_KLBDATASET          (58| CLS_KLBENGINECLASS)
#define CLS_KLBNODEVIRTUALDOC	(59| CLS_KLBENGINECLASS | CLS_KLBUICORECLASS)
#define CLS_KLBFONTOBJ		    (60| CLS_KLBENGINECLASS)
#define CLS_KLBSOUNDOBJ		    (61| CLS_KLBENGINECLASS)
#define CLS_KLBMATRIXOBJ	    (62| CLS_KLBENGINECLASS)
#define CLS_KLBVECTOROBJ	    (63| CLS_KLBENGINECLASS)

#define CLS_KLBUNITTASK		    (64| CLS_KLBUSERTASK)
#define CLS_KLBMAPGROUP		    (65| CLS_KLBUSERTASK)

#define CLS_KLBSTORESERVICE	    (66| CLS_KLBUSERTASK | CLS_NONVISUALTASK)
#define CLS_KLBNETAPI		    (67| CLS_KLBUSERTASK | CLS_NONVISUALTASK)
#define CLS_KLBPAUSECTRL	    (68| CLS_KLBUSERTASK | CLS_NONVISUALTASK)
#define CLS_KLBLIFECTRL		    (69| CLS_KLBUSERTASK | CLS_NONVISUALTASK)
#define CLS_KLBAIDRIVERTASK	    (70| CLS_KLBUSERTASK | CLS_NONVISUALTASK)
#define CLS_KLBWORDLTASK	    (71| CLS_KLBUSERTASK | CLS_NONVISUALTASK)
#define CLS_KLBUIWEBVIEW	    (72| CLS_KLBUSERTASK)

#define CLS_KLBAPPPROP		    (73| CLS_KLBENGINECLASS)

#define CLS_KLBACTIVITYINDICATORNODE    (74| CLS_KLBENGINECLASS)    // CKLBActivityIndicatorNode
#define CLS_KLBUIACTIVITYINDICATOR      (75| CLS_KLBUSERTASK)       // CKLBUIActivityIndicator

#define CLS_KLBUIVARIABLEITEM			(76| CLS_KLBUSERTASK)
#define CLS_KLBUICLIP					(77| CLS_KLBUSERTASK)
#define CLS_KLBAPPUPDATE				(78| CLS_KLBENGINECLASS)
#define CLS_KLBASYNCLOADER				(79| CLS_KLBUSERTASK | CLS_NONVISUALTASK)
#define CLS_KLBGCTASK					(80| CLS_KLBUSERTASK | CLS_NONVISUALTASK)
#define CLS_KLBAPPUPDATEZIP				(81| CLS_KLBUSERTASK | CLS_NONVISUALTASK)
#define CLS_KLBASYNCFILECOPY			(82| CLS_KLBUSERTASK | CLS_NONVISUALTASK)

#define CLS_KLBUIBUTTON		            (83| CLS_KLBUSERTASK)
#define CLS_KLBPACKERCTRL	            (84| CLS_KLBENGINECLASS)

// it's here temporary
#define CLS_DOWNLOADCLIENT              (85| CLS_KLBUSERTASK)
#define CLS_NOTIFICATIONMANAGER         (86| CLS_KLBUSERTASK | CLS_NONVISUALTASK)
#define CLS_MICRODL                     (87| CLS_KLBUSERTASK)
#define CLS_ADMANAGER                   (88| CLS_KLBUSERTASK)
